...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenido a Hundir la flota, contra quien desea jugar: \n 1 - otro jugador \n 2 - La maquina");
    ...
    while (!juegoTerminado) {
        for (int i = 0; i < turnos; i++) {
            ...
            cantidadCasillasJugador1 = seleccionarCasilla(tableroJugador2, tableroBarcosJugador1, cantidadCasillasJugador1, barcosJugador1);
    ...
    static void crearBarcos(char[][] tablero) {               
        ...
        while (barcosRestantes != 0) {
            Scanner scanner = new Scanner(System.in);
            System.out.println("Que barco deseas colocar (elija una opcion): \nOpción    Nombre          Tamaño \n1    -    portaaviones    (5) \n2    -    acorazado       (4) \n3    -    submarino       (3) \n4    -    crucero         (3) \n5    -    destructor      (2) \n");
            ...
            switch (barco){
                ...
                switch (direccion){
                    ...
                    if (longitudNormal != portaaviones && longitudReversa != portaaviones) {
                ...
                switch (direccion){
                    ...
                    if (longitudNormal != acorazado && longitudReversa != acorazado) {
                        System.out.println("Coordenadas no validas, ingrese valores correctos.");
                        break;
                    }
                ...
                switch (direccion){
                    ...
                    if (longitudNormal != submarino && longitudReversa != submarino) {
                        System.out.println("Coordenadas no validas, ingrese valores correctos.");
                        break;
                    }
                ...
                switch (direccion){
                    ...
                    if (longitudNormal != crucero && longitudReversa != crucero) {
                        System.out.println("Coordenadas no validas, ingrese valores correctos.");
                        break;
                    }
                ...
                switch (direccion){
                    ...
                    if (longitudNormal != destructor && longitudReversa != destructor) {
                        System.out.println("Coordenadas no validas, ingrese valores correctos.");
                        break;
                    }
            ...
            // Comprobar
            System.out.println();
            System.out.println("Barcos Jugador 1: ");
            System.out.println();
